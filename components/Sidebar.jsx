  ...
  return (
    ...
    >
      <div>
        ...
        >
          {expand ? (
            <h1 className="text-gray-400 text-2xl ">ChiNova</h1>
          ) : (
            <Image src={assets.favicon} alt="" />
          )}

          <div
            onClick={() => (expand ? setExpand(false) : setExpand(true))}
            className="group relative flex items-center justify-center hover:bg-gray-500/20 transition-all rounded-lg duration-300 h-9 w-9 aspect-square"
          >
